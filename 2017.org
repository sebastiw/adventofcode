...
#+BEGIN_SRC awk :stdin spiral-memory-input
  {
      ...
      sq=sqrt($0)
      # Round square up
      sq=(sq==int(sq) ? int(sq) : int(sq)+1)
      # know we know sq is the length of the side.
      hl=int(sq/2)
      mhl=hl+1
      print "Side-length " sq
      print "Half-length " hl
      ...
      print "Last-cube-num " last

      small_side=sq
      bl=last-small_side
      tl=last-2*small_side
      tr=last-3*small_side
      br=last-4*small_side+1
